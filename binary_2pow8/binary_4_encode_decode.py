...
# does taht reliably for us 
    ...
    ic(inner_product_bytes_bin8(P1,P1))
    ic(inner_product_bytes_bin8(P2,P2))
    ic(inner_product_bytes_bin8(P3,P3))
    ic(inner_product_bytes_bin8(P1,P2))
    ic(inner_product_bytes_bin8(P1,P3))
    ic(inner_product_bytes_bin8(P2,P3))
